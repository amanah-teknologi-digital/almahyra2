        ...
        <div class="app-admin-wrap layout-sidebar-compact sidebar-dark-purple sidenav-open clearfix">
            ...
            <div class="main-content-wrap d-flex flex-column">
                ...
                <div class="main-content">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <a href="<?= base_url().$redirect2 ?>" class="btn btn-secondary mb-3"><i class="fas fa-arrow-left"></i> Kembali</a>
                            <div class="card text-left">
                                <div class="card-body">
                                    ...
                                    <?php echo form_open_multipart($controller.'/simpanrekammedikbackdate', 'id="frm_simpan" enctype="multipart/form-data"'); ?>
                                        <fieldset>
