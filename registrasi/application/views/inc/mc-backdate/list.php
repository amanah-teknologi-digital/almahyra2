    ...
    <body class="text-left">
        <div class="app-admin-wrap layout-sidebar-compact sidebar-dark-purple <?= $role != 5 ? 'sidenav-open':''; ?> clearfix">
            ...
            <div class="main-content-wrap d-flex flex-column">
                            ...
                            <div class="card text-left">
                                <div class="card-body">
                                    ...
                                    <table style="width: 100%;padding: 10px 10px;">
                                        ...
                                        <tr>
                                            <td>
                                                <label>Tanggal Medical Checkup</label>
                                            </td>
                                            <td>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <h5 class="card-title text-center">Hasil Medical Checkup Hari&nbsp;<span class="font-weight-bold"><?= format_date_indonesia($tanggal_mc).', '.date('d-m-Y', strtotime($tanggal_mc)); ?></span></h5>
                                        </div>
                                    </div>
                                    <br>
                ...
                <form action="<?= $controller.'/checkAktivitasBackdate' ?>" id="frm_lihatdetail" method="POST">
