                                ...
                                <div class="card-body">
                                    ...
                                    <?php echo form_open_multipart($controller.'/cetakkebutuhananak', 'target="blank"'); ?>
                                        <div class="row d-flex justify-content-center align-items-center">
                                            <div class="col-sm-10">
                                                <h5 class="card-title mb-1 d-flex align-content-center justify-content-between"><span class="float-left">Data Antar Jemput Anak&nbsp;<?= !empty($id_anak)? 'a.n&nbsp;<span class="text-success font-weight-bold">'. $data_anak->nama_anak.'</span>':''?></span></h5>
                                            </div>
                                            <div class="col-sm-2">
